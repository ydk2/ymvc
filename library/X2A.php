                ...
                if (is_array($tagname)) {
                    ...
                    foreach ($tagname as $tagkey => $tagvalue) {
                        ...
                        elseif ($tagkey !== "@attributes") {
                            if (!is_int($tagkey)) {
                                $tmp[3] .= call_user_func_array(array($this, __FUNCTION__), array($tagname));//$this->a2x($tagvalue);
                            } else {
                                $tmp[3] .= call_user_func_array(array($this, __FUNCTION__), array($tagvalue));//$this->a2x($tagvalue);
                            }
                        }
                    }
                } else {

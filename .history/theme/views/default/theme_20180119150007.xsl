	...
	<xsl:template match="/">
		...
		<html lang="{data/lang}">
			<head>
				...
				<!-- Bootstrap CSS -->
				<link href="../library/js/bootstrap/3.3.6/css/bootstrap.min.css" rel="stylesheet"/>
				<!--
...
-->
				...
				<script src="../library/js/bootstrap/3.3.6/js/bootstrap.min.js"></script>
				<link href="../library/js/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
				<link href="../library/css/bs-style-nice.css" rel="stylesheet" type="text/css"/>
				<style>
					<![CDATA[
html, body {
width: 100%;

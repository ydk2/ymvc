...
class Users extends PHPRender {
	...
	public function ulist(){
		...
		foreach ($this->List as $key => $value) {
			...
			$this->usersList[$i]['account_name']=$this->model->get_name_idx($table,'account_name',$value,$gprx)[0]['name'];
			$this->usersList[$i]['account_login']=$this->model->get_name_idx($table,'account_login',$value,$gprx)[0]['name'];
			$this->usersList[$i]['account_role']=$this->model->get_name_idx($table,'account_role',$value,$gprx)[0]['name'];

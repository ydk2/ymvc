...
class Users extends PHPRender {
	...
	public function ulist(){
		...
		foreach ($this->List as $key => $value) {
			...
			$this->usersList[$i]['account_name']=$this->model->get_name_idx($table,'account_name',$value[0]['idx'],$gprx);
			$this->usersList[$i]['account_login']=$this->model->get_name_idx($table,'account_login',$value[0]['idx'],$gprx);
			$this->usersList[$i]['account_role']=$this->model->get_name_idx($table,'account_role',$value[0]['idx'],$gprx);

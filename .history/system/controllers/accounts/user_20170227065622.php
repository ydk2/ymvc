        ...
        if(strpos($key, "account_") !== false && $value != ''){
            switch ($key) {
                ...
                case 'account_born':
                    ...
                    $this->subview2 .= '<h2>'.$value.' '.helper::validate($value,'date').'</h2>';
                    break;
                case 'account_email':
                    $this->subview2 .= '<h2>'.$value.' '.helper::validate($value,'email').'</h2>';
                    break;
                case 'account_pass':
                    $this->subview2 .= '<h2>'.$value.' '.$helper::validate($value,'alphanum',6,30).'</h2>';
                    break;
                case 'account_adnotation':
                    $this->subview2 .= '<h2>'.$value.' '.helper::validate($value,'text',20,100).'</h2>';
                    break;

                default:
                    $this->subview2 .= '<h2>'.$value.' '.helper::validate($value,'alphanum').'</h2>';
                    break;
            }

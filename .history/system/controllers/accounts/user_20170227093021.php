...
class User extends PHPRender {
    ...
    public function Init() {
        ...
        $this->required = array(
            ...
            'account_email'=>array('email'),
            'account_born'=>array('date'),
...
public function ushownew(){
    ...
    if(!empty(helper::session('account_new'))){
        ...
        if(strpos($key, "account_") !== false && $value != ''){
            switch ($key) {
                case 'account_born':
                    ...
                    $retbool += helper::validate($value,'date');
                    break;
                case 'account_email':
                    $retbool += helper::validate($value,'email');
                    break;
                case 'account_name':
                    $retbool += helper::validate($value,'text',3,40);
                    break;
                case 'account_pass':
                    $retbool += helper::validate($value,'alphanum',6,99);
                    break;
                case 'account_login':
                    $retbool += helper::validate($value,'alphanum',3,40);
                    break;
            }

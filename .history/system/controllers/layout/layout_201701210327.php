...
class Layout extends XSLRender {
	...
	public function array_search_rotate($data,$search_value='',$search_name='_name',$_value='value',$_name='name',$indexed=1){
    $aout = array();
                ...
                foreach ($data as $name=>$value) {
                    if($item===$value['index']){
                        if(!$indexed){
                            ...
                            $values[$value[$_name]]['name']=array_search($value[$_name], $value);
	...
	public function array_rotate($data,$search_name='_name',$_name='name',$_value='value',$indexed=1){
    $aout = array();
    foreach ($data as $items) {

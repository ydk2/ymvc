...
class MNGLayouts extends XSLRender {
    ...
    public function input($name,$value='',$type='text',$for='text1',$dataattr=''){
        return '<div class="input-group">
        <span class="input-group-addon" id="'.$for.'">'.ucfirst($name).'</span>
        <input type="'.$type.'" class="form-control" name="'.$name.'" value="'.$value.'"  placeholder="'.$name.'"aria-describedby="'.$for.'">
        '.$dataattr.'
        </div>';
    }

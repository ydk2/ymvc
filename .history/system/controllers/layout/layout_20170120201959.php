...
public $mode;
	...
	public function Run(){
		...
		$data = array(
			...
			array('id'=>3,'key'=>1,'type'=>'module','name'=>'_group','group'=>'one','value'=>'','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>4,'key'=>1,'type'=>'module','name'=>'_view','group'=>'one','value'=>'one','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>5,'key'=>1,'type'=>'module','name'=>'_pos','group'=>'one','value'=>1,'category'=>'layout','option'=>"2",'data'=>''),
			...
			array('id'=>8,'key'=>2,'type'=>'route','name'=>'_name','group'=>'two','value'=>'two','category'=>'layout','option'=>"1",'data'=>''),
			array('id'=>9,'key'=>2,'type'=>'route','name'=>'_controller','group'=>'two','value'=>'two','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>10,'key'=>2,'type'=>'route','name'=>'_group','group'=>'two','value'=>'','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>11,'key'=>2,'type'=>'route','name'=>'_view','group'=>'two','value'=>'two','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>12,'key'=>2,'type'=>'route','name'=>'_pos','group'=>'two','value'=>1,'category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>13,'key'=>2,'type'=>'route','name'=>'_attr','group'=>'two','value'=>'a:3:{s:2:"id";s:0:"";s:5:"class";s:3:"row";s:5:"style";s:0:"";}','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>14,'key'=>2,'type'=>'route','name'=>'_type','group'=>'two','value'=>'route','category'=>'layout','option'=>"2",'data'=>''),
		);
		var_dump($data);
		$_name = 'name';
		$_value = 'group';
		...
		foreach ($data as $items) {
			...
			$values = array();
				foreach ($data as $value) {
					if($item===$value['key']){
						$values[$items['key']]=array($value['name']=>$value['value']);
						//$aout[$items['key']]['_id']=$value['key'];
						//$aout[$items['key']][$value['name']][$value['id']]=$value['value'];

					}
				}
				$aout[$items['key']]=$values;
			}
			}
		}
		var_dump($aout);

...
class Layout extends XSLRender {
    ...
    public function Run(){
        ...
        array('id'=>15,'index'=>3,'name'=>'_name','value'=>'three','option'=>"1"),
        ...
        $aout[14]['_view']['value']='changed';
        $aout[14]['_view']['category']='changed';
        $aout[14]['_pos']['value']=3;
        //unset($aout[0]);
        //var_dump($aout);
        $rmout=$this->array_rotate_delete_index($data,1,'index','id');
        //$allupdateout=$this->array_rotate_key_value($aout,'name','value');
        //var_dump($rmout);
        $uout=$this->array_rotate_update($data,$aout,'id');
        //var_dump($uout);
        $allout=$this->array_rotate($uout,'_name','value','name','index','id');
    ...
    public function array_rotate_add($data,$add,$index='index',$control='id'){
        $updatein = array();
        $updateout = $data;
    ...
    public function array_rotate_delete_index($data,$delete,$index='index',$control='id'){
        $updatein = array();
        $updateout = $data;
                foreach ($data as $i => $item) {
                    if(isset($item[$index])){
        ...
        foreach ($updated as $entry) {
            foreach ($entry as $key => $value) {
                ...
                foreach ($data as $index => $item) {
                    $update=array();
                    if(isset($item[$control]) && isset($updatein[$value[$control]][$control])){

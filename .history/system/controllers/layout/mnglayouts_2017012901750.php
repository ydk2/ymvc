...
class MNGLayouts extends XSLRender {
    ...
    public function input($name,$value='',$type='text',$for='text1'){
        return '<div class="form-group">
            <div class="col-sm-2">
                <label for="'.$for.'" class="control-label">'.ucfirst($name).'</label>
            </div>
            <div class="col-sm-10">
              <input type="email" class="form-control" id="'.$for.'" name="'.$name.'" value="'.$value.'"  placeholder="Email">
            </div>
        </div>';
    }
    public function layout_values($value){
        ...
        $contents .= $this->input('name',$value['name'],'text',$id++);
        $contents .= $this->input('module',$value['module'],'text',$id++);
        $contents .= $this->input('view',$value['view'],'text',$id++);
        $contents .= $this->input('class',$value['class'],'text',$id++);
        $contents .= $this->input('attrid',$value['attrid'],'text',$id++);
        $contents .= $this->input('mode',$value['mode'],'text',$id++);
        return $contents;
    }

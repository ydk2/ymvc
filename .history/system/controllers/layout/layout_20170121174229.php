 ...
 * @Last Modified time: 2017-01-21 17:39:41
 */
...
class Layout extends XSLRender {
    ...
    public function Run(){
        ...
        array('id'=>8,'index'=>3,'type'=>'route','name'=>'_name','group'=>'two','value'=>'two','category'=>'none','option'=>"1",'data'=>''),
        array('id'=>9,'index'=>3,'type'=>'route','name'=>'_controller','group'=>'two','value'=>'two','category'=>'none','option'=>"2",'data'=>''),
        array('id'=>10,'index'=>3,'type'=>'route','name'=>'_group','group'=>'two','value'=>'','category'=>'none','option'=>"2",'data'=>''),
        array('id'=>11,'index'=>3,'type'=>'route','name'=>'_view','group'=>'two','value'=>'two','category'=>'none','option'=>"2",'data'=>''),
        array('id'=>12,'index'=>3,'type'=>'route','name'=>'_pos','group'=>'two','value'=>1,'category'=>'none','option'=>"2",'data'=>''),
        array('id'=>13,'index'=>3,'type'=>'route','name'=>'_attr','group'=>'two','value'=>'a:1:{s:5:"style";s:0:"";}','category'=>'none','option'=>"2",'data'=>''),
        array('id'=>14,'index'=>3,'type'=>'route','name'=>'_type','group'=>'two','value'=>'route','category'=>'none','option'=>"2",'data'=>''),
        );
        //var_dump($data);

...
public $mode;
	...
	public function Run(){
		...
		$layouts = array(
			array('id'=>1,'key'=>1,'type'=>'module','name'=>'one','group'=>'one','value'=>'one','category'=>'layout','option'=>"1"),
			array('id'=>2,'key'=>1,'type'=>'module','name'=>'one','group'=>'one','value'=>'one','category'=>'layout','option'=>"2"),
			array('id'=>3,'key'=>1,'type'=>'module','name'=>'one','group'=>'one','value'=>'one','category'=>'layout','option'=>"2"),
			array('id'=>4,'key'=>1,'type'=>'module','name'=>'one','group'=>'one','value'=>'one','category'=>'layout','option'=>"2"),
			array('id'=>5,'key'=>1,'type'=>'module','name'=>'one','group'=>'one','value'=>'one','category'=>'layout','option'=>"2"),
			array('id'=>6,'key'=>1,'type'=>'module','name'=>'one','group'=>'one','value'=>'one','category'=>'layout','option'=>"2"),
		);
		$this->Layouts();

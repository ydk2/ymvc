...
class MNGLayouts extends XSLRender {
    ...
    public function layout_values($value){
        $contents = htmlspecialchars("<h4>".ucfirst($value['name'])."</h4>");
        $contents .= htmlspecialchars("<p>".$value['pos']."</p>");
        $contents .= htmlspecialchars("<p>".$value['module']."</p>");
        $contents .= htmlspecialchars("<p>".$value['view']."</p>");
        $contents .= htmlspecialchars("<p>".$value['class']."</p>");
        $contents .= htmlspecialchars("<p>".$value['attrid']."</p>");

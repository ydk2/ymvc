...
class MNGLayouts extends XSLRender {
    ...
    public function Run(){
        ...
        $showsort = '<div class="row"><strong>Show as</strong><ul class="breadcrumb">';
        $showsort .= '<li><a href="'.HOST_URL.'?layout'.S.'mnglayouts&amp;group='.$group.'&amp;showas=list">list</a></li>';
        $showsort .= '<li><a href="'.HOST_URL.'?layout'.S.'mnglayouts&amp;group='.$group.'&amp;showas=items">items</a></li>';
        $showsort .= '<li><a href="'.HOST_URL.'?layout'.S.'mnglayouts&amp;group='.$group.'&amp;showas=plate">plate</a></li>';
        $showsort .= '</ul></div>';

...
public $mode;
	...
	public function Run(){
		...
		$data = array(
			...
			array('id'=>8,'key'=>2,'type'=>'module','name'=>'_name','group'=>'one','value'=>'one','category'=>'layout','option'=>"1",'data'=>''),
			array('id'=>9,'key'=>2,'type'=>'module','name'=>'_controller','group'=>'one','value'=>'one','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>10,'key'=>2,'type'=>'module','name'=>'_group','group'=>'one','value'=>'one','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>11,'key'=>2,'type'=>'module','name'=>'_view','group'=>'one','value'=>'one','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>12,'key'=>2,'type'=>'module','name'=>'_pos','group'=>'one','value'=>'one','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>13,'key'=>2,'type'=>'module','name'=>'_attr','group'=>'one','value'=>'a:3:{s:2:"id";s:0:"";s:5:"class";s:3:"row";s:5:"style";s:0:"";}','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>14,'key'=>2,'type'=>'module','name'=>'_type','group'=>'one','value'=>'module','category'=>'layout','option'=>"2",'data'=>''),
		);
		var_dump($data);
		$_name = 'name';
		$_value = '';

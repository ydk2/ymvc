...
public $mode;
	...
	public function Run(){
		...
		$data = array(
			array('id'=>1,'key'=>1,'type'=>'module','name'=>'_name','group'=>'one','value'=>'one','category'=>'layout','option'=>"1",'data'=>''),
			array('id'=>2,'key'=>1,'type'=>'module','name'=>'_controller','group'=>'one','value'=>'one','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>3,'key'=>1,'type'=>'module','name'=>'_group','group'=>'one','value'=>'one','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>4,'key'=>1,'type'=>'module','name'=>'_view','group'=>'one','value'=>'one','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>5,'key'=>1,'type'=>'module','name'=>'_pos','group'=>'one','value'=>'one','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>6,'key'=>1,'type'=>'module','name'=>'_attr','group'=>'one','value'=>'a:3:{s:2:"id";s:0:"";s:5:"class";s:3:"row";s:5:"style";s:0:"";}','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>7,'key'=>1,'type'=>'module','name'=>'_type','group'=>'one','value'=>'module','category'=>'layout','option'=>"2",'data'=>''),

			array('id'=>8,'key'=>2,'type'=>'module','name'=>'_name','group'=>'two','value'=>'two','category'=>'layout','option'=>"1",'data'=>''),
			array('id'=>9,'key'=>2,'type'=>'module','name'=>'_controller','group'=>'two','value'=>'two','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>10,'key'=>2,'type'=>'module','name'=>'_group','group'=>'two','value'=>'two','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>11,'key'=>2,'type'=>'module','name'=>'_view','group'=>'two','value'=>'two','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>12,'key'=>2,'type'=>'module','name'=>'_pos','group'=>'two','value'=>'two','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>13,'key'=>2,'type'=>'module','name'=>'_attr','group'=>'two','value'=>'a:3:{s:2:"id";s:0:"";s:5:"class";s:3:"row";s:5:"style";s:0:"";}','category'=>'layout','option'=>"2",'data'=>''),
			array('id'=>14,'key'=>2,'type'=>'module','name'=>'_type','group'=>'two','value'=>'module','category'=>'layout','option'=>"2",'data'=>''),
		);
		var_dump($data);
		$_name = 'name';
		$_value = '';
		$search_name = '_controller';
		$search_value = 'one';
		$search_key = 0;
		$out = "";
		$aout = array();
		foreach ($data as $items) {
			...
			if($search_name==$items[$_name] && $search_value==$items['value']){
			$item = $items['key'];
				foreach ($data as $value) {
					if($item==$items['key']){
						$out .= '<p>'.serialize($items).'</p>';
						$aout[$items['key']][$value['id']]=array(

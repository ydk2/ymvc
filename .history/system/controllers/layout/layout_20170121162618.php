 ...
 * @Last Modified time: 2017-01-21 16:26:05
 */
...
class Layout extends XSLRender {
    ...
    public function Run(){
        ...
        //var_dump($allout);
        $allupdateout=$this->array_rotate_value_by_key($allout,'categories');
    ...
    public function array_rotate_value_by_key($data,$search='value'){
        $updateout = array();
        $i = 0;

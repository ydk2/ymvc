...
public $mode;
	...
	public function Run(){
		...
		$data = array(
			...
			array('id'=>13,'index'=>2,'type'=>'route','name'=>'_attr','group'=>'two','value'=>'a:3:{s:2:"id";s:0:"";s:5:"class";s:3:"row";s:5:"style";s:0:"";}','category'=>'layout','option'=>"2",'data'=>''),
			...
			$values = array();
				foreach ($data as $value) {
					if($item===$value['index']){
						...
						//$aout[$items['index']]['_id']=$value['index'];
						//$aout[$items['index']][$value['name']][$value['id']]=$value['value'];

...
class pLayout extends PHPRender {
    ...
    public function Run(){
        ...
        $this->ViewData('layout', new stdClass);
        var_dump($this->data);
        $this->Layouts();
    }
            ...
            if($value['group']==$group && $yes && $value['group']!=$value['name']){
                ...
                if($value['module']=="layout" && $value['group']!=""){
                    if(!in_array($value['name'],$disabled)){
                        ...
                        $content = new $this(SYS.V.'layout'.S.'views');
                        ...
                        if($contents!=""){
                            $this->data->layout->views[$i]['content'] = $contents;
                            if(isset($value['class'])) $this->data->layout->views[$i]['class'] = $value['class'];
                        }
                        $content = NULL;
                        $contents = NULL;
                        $col = NULL;

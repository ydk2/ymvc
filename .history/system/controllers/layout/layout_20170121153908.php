...
class Layout extends XSLRender {
    ...
    public function Run(){
        ...
        //var_dump($data);
        $aout=$this->array_search_rotate($data,'two');
        var_dump($aout);
	...
	public function array_search_rotate($data,$search_value='',$search_name='_name',$_value='value',$_name='name',$index='index'){
    $aout = array();
                ...
                foreach ($data as $value) {
                    if($item===$value['index']){
                        if(!$indexed){
                            ...
                            $values[$value[$_name]]['id']=$value['id'];
                        } else {
                            $values[$value[$_name]]['name']=$value[$_name];
                            $values[$value[$_name]]['value']=$value[$_value];
                            $values[$value[$_name]]['id']=$value['id'];
                        }
	...
	public function array_rotate($data,$search_name='_name',$_name='name',$_value='value',$index='index'){
    $aout = array();
    foreach ($data as $items) {

...
class LoadContent extends XSLRender {
	...
	public function onInit(){
		...
		$this->current_parent = (Helper::Session('user_role')!="")?Helper::Session('user_role'):'any';
	...
	public function onRun($model = NULL){
		...
		$default_items = array(
			...
			array('id'=>1,'pos' => 1, 'name'=>'menu','module'=>'admin:menu','view'=>'elements:nav','class'=>'row', 'mode'=>'', 'parent'=>'admin', 'attrid'=>'', 'users'=>''),
			array('id'=>2,'pos' => 1, 'name'=>'menu','module'=>'admin:menu','view'=>'elements:nav','class'=>'row', 'mode'=>'', 'parent'=>'any', 'attrid'=>'', 'users'=>''),
			
			// layout
			array('id'=>4,'pos' => 2, 'name'=>'admin', 'module'=>'layout','view'=>'','class'=>'row', 'mode'=>'', 'parent'=>'admin', 'attrid'=>'', 'users'=>''),
			// items
			array('id'=>7,'pos' => 3, 'name'=>'one', 'module'=>'other:one','view'=>'other:one','class'=>'col-sm-4', 'mode'=>'', 'parent'=>'admin', 'attrid'=>'', 'users'=>''),
			array('id'=>5,'pos' => 4, 'name'=>'two', 'module'=>'other:two','view'=>'other:two','class'=>'col-sm-8', 'mode'=>'', 'parent'=>'admin', 'attrid'=>'', 'users'=>''),
			
			// sections
			array('id'=>6,'pos' => 3, 'name'=>'any', 'module'=>'layout','view'=>'','class'=>'row', 'mode'=>'', 'parent'=>'any', 'attrid'=>'', 'users'=>''),
			// items
			array('id'=>3,'pos' => 2, 'name'=>'login','module'=>'admin:account','view'=>'admin:login','class'=>'col-sm-12', 'mode'=>'', 'parent'=>'any', 'attrid'=>'', 'users'=>''),

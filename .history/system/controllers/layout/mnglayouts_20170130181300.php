...
public function dump($value){
    ...
    public function add_layout_item(){
        ...
        $pos = $ipos;
        $idx = $this->model->GetFreeIdx($this->array);
        $contents = "<h4>Dodaj do '".$this->group."'</h4>";
        ...
        $contents .= '<input type="text" class="form-control" name="item['.$idx.'][module]" value=""  placeholder="name">';

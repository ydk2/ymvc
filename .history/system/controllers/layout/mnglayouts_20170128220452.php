...
class MNGLayouts extends XSLRender {
	...
	function menu($data) {
		...
		$i = 1;
		foreach ($data as $item) {
				$tree .= '<li class="list-group-item"><a href="'.HOST_URL.'?layout'.S.'mnglayouts&amp;group='.$item.'">'.$item.'</a></li>' . PHP_EOL;
			}
		$tree .= "</ul>";
		return $tree;
	}
    ...
    public function Run(){
        ...
        $showsort = '<div class="row"><ul>';
        $showsort .= '<li><a href="'.HOST_URL.'?layout'.S.'mnglayouts&amp;group='.$group.'&amp;showas=list">list</a></li>';
        $showsort .= '<li><a href="'.HOST_URL.'?layout'.S.'mnglayouts&amp;group='.$group.'&amp;showas=items">list</a></li>';
        $showsort .= '<li><a href="'.HOST_URL.'?layout'.S.'mnglayouts&amp;group='.$group.'&amp;showas=plate">list</a></li>';
        $showsort .= '</ul></div>';

...
//echo $this->current_group;
    ...
    $header .= '
    <link href="libriares/libs/datepicker/css/datepicker.css" rel="stylesheet">
    <script type="text/javascript" src="libriares/libs/datepicker/js/datepicker.js"></script>';
    $this->header=$header;
    }

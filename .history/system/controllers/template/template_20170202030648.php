...
class Template extends PHPRender {
    ...
    {
        $this->SetModule(SYS.V.'layout'.S.'views',SYS.C.'layout'.S.'playout');
        $content = $this->GetModule(SYS.C.'layout'.S.'playout');
		...
		$items = unserialize(file_get_contents(ROOT.STORE.'layouts.data'));

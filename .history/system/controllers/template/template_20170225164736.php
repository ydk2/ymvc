...
//echo $this->current_group;
    ...
    <script type="text/javascript" src="libriares/libs/codemirror/lib/codemirror.js"></script>
    <script type="text/javascript" src="libriares/libs/codemirror/mode/xml/xml.js"></script>
    <script type="text/javascript" src="libriares/libs/codemirror/lib/formatting.js"></script>
    <!-- -->
    <script src="libriares/libs/codemirror/addon/hint/show-hint.js"></script>
    <script src="libriares/libs/codemirror/addon/hint/xml-hint.js"></script>
    <script src="libriares/libs/codemirror/addon/hint/html-hint.js"></script>
    <script src="libriares/libs/codemirror/mode/xml/xml.js"></script>
    <script src="libriares/libs/codemirror/mode/javascript/javascript.js"></script>
    <script src="libriares/libs/codemirror/mode/css/css.js"></script>
    <script src="libriares/libs/codemirror/mode/htmlmixed/htmlmixed.js"></script>
    <!-- -->
    ...
    $header .= '
    <link href="libriares/libs/datapicker/css/datepicker.css" rel="stylesheet">
    <script type="text/javascript" src="libriares/libs/datapicker/js/datepicker.js"></script>';
    $this->header=$header;
    }

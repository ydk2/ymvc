...
class MngLayout extends XSLRender {
    ...
    public function oldRun($model = NULL){
        ...
        array('id'=>1,'pos' => 1, 'name'=>'menu','module'=>'admin'.S.'menu','view'=>'elements:nav','class'=>'row', 'model'=>'', 'group'=>'admin', 'attrid'=>'', 'users'=>''),
        array('id'=>2,'pos' => 1, 'name'=>'menu','module'=>'admin'.S.'menu','view'=>'elements:nav','class'=>'row', 'model'=>'', 'group'=>'any', 'attrid'=>'', 'users'=>''),
    ...
    protected function manage(){
        ...
        $modules = array(
        "admin".S."menu"=>array("elements:nav","admin".S."account","admin".S."login"),
        "other:two"=>array("elements:nav","admin".S."account","admin".S."login","other:two"),

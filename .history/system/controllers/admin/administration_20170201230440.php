...
class Administration extends PHPRender {
    ...
    public function Run(){
        //$this->model->createTableRotate('mainsettings','');
        $default = array(
        array(
            'theme'=>'empty',
            'menu'=>'default',
        ...
        $this->model->Begin(Helper::Session('token'));
            ...
            $this->model->doAddItems($default,'mainsettings','');
        ...
        $chk=$this->model->Commit(Helper::Session('token'));
            ...
            $datalist=$this->model->search_entries('mainsettings','');
            $this->datalist = $datalist[1];

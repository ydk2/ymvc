...
class Manage extends PHPRender {
    ...
    public function modules(){
        ...
        $this->app=(Helper::get('app')=='')?'system'.DS:Helper::get('app').DS;
        ...
        if(Helper::get('action')){
            ...
            $this->files=FileUtils::inDir(ROOT.$this->app.C.Helper::get('path').'/*'); //+FileUtils::inDir(ROOT.APP.C.Helper::get('path').'/*');
        }

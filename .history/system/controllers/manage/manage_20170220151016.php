...
class Manage extends PHPRender {
    ...
    public function choose(){
        ...
        $one3 = $this->model->getData(Config::$data['layout_data']);
    ...
    public function Run(){
        switch ($this->view) {
            ...
            case SYS.V."manage".DS."modules" || SYS.V."manage".DS."modules".DS."list" || SYS.V."manage".DS."modules".DS.'edit' || SYS.V."manage".DS."modules".DS.'available':
    ...
    public function modules(){
        switch ($this->view) {
            ...
            case SYS.V."manage".DS."modules".DS.'edit':
                $this->data->link = HOST_URL.'?manage'.S.'manage'.'='.'manage'.S.'modules'.S.'edit&group='.$this->group.'';
        ...
        $this->data->header = 'Brak elementów';
        $this->data->text = 'Dodaj nowy';
        if(is_file(base64_decode(helper::get('path')))){
            $this->Actionmodules();
        } else {
            $path = (helper::get('path')=="")?ROOT.$this->app.DS.C:base64_decode(helper::get('path'));
    ...
    private function Actionmodules(){
        ...
        if(Helper::post('items') && Helper::get('action')=="edit"){
           // $this->setview(SYS.V . "manage".S."modules".S.'edit');

...
class Manage extends PHPRender {
    ...
    public function modules(){
        ...
        $this->group=(Helper::get('app')=='')?'system':Helper::get('app');
        ...
        if(Helper::get('action')){
            ...
            $this->files=FileUtils::inDir(ROOT.Helper::get('app').DS.C.Helper::get('path').'/*'); //+FileUtils::inDir(ROOT.APP.C.Helper::get('path').'/*');
        }

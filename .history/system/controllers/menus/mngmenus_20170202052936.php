...
class MNGMenus extends PHPRender {
    ...
    public function Run(){
        ...
        if(Helper::get('action')){
            ...
            //$this->Save();
            $this->data->message->link = HOST_URL.'?menus'.S.'mngmenus&group='.$this->group.'';
        } else {
    ...
    private function Save(){
        if(Helper::get('action')=='add' && isset($_POST['add'])){
            ...
            foreach ($this->datalist as $pos => $val) {
                ...
                $this->data->message->header = 'Uwaga!!!';
                $this->data->message->text = 'Pola nazwy i modułu nie mogą być puste';
            }
        ...
        $this->data->message->header = 'Błąd!!!';
        $this->data->message->text = 'Operacja Nie Istnieje';
    }

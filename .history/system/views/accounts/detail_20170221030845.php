<div class="row">
  <div class="col-sm-12">
    ...
    <?php } ?>
        ...
        <form class="form-horizontal text-info .form" method="POST" action="test.php"
        role="form">
            ...
            <div class="form-group">
              <div class="col-sm-12">
                ...
                <label class="checkbox-inline">
                  <input id="d-login-check" type="checkbox" data-toggle="toggle" data-on="Tak"
                ...
                <label class="checkbox-inline">
                  ...
                  data-onstyle="success" data-offstyle="danger" checked="checked">
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <select name="account_type" class="form-control combobox">
                    <option disabled="disabled">Administrator</option>
          ...
          <fieldset class="d-login">
            <div class="form-group">
              <div class="col-sm-12">
                ...
                <div class="input-group">
                  <input name="account_login" type="text" class="form-control">
                  <span class="input-group-addon">
            ...
            <div class="form-group" id="u-pass">
              <div class="col-sm-12">
                <div class="input-group">
                  <input name="account_pass" type="password" class="form-control" disabled="disabled">
                  <span class="input-group-addon">
                    <i class="fa fa-lg fa-lock"></i>&nbsp;Hasło</span>
                  <span class="input-group-btn">
                    <a class="btn btn-warning" type="submit" id="show-pass" data-toggle="button"><i class="fa fa-lg -circle fa-eye icon-pass"></i>&nbsp;Pokaż</a>
                  </span>
                </div>
              </div>
            </div>

<div class="row">
  <div class="col-sm-12">
    <?php if(!empty($this->userdetails)){ ?>
	  ...
	  <?php if (strpos($ukey, 'account_') !== false) { ?>
         ...
         <fieldset class="d-account">
            <div class="form-group">
              <div class="col-sm-12">
                ...
                <label class="checkbox-inline">
                  ...
                  <input name="can_login" <?=($this->userdetails['account_login']=='y')?'checked="checked"':'';?>  value="<?=$this->userdetails['can_login']?>" id="d-login-check" type="checkbox" data-toggle="toggle" data-on="Tak"
          ...
          <fieldset class="d-login">
            ...
            <div class="form-group" id="u-pass">
              <div class="col-sm-12">
                <div class="input-group">
                  <input name="account_pass" value="<?=$this->userdetails['account_pass']?>" type="password" class="form-control">
                  <span class="input-group-addon">

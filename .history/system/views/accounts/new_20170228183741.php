         ...
         <fieldset class="d-account">
          ...
          <fieldset class="d-contact">
            ...
            <div class="form-group d-can-del">
              <div class="col-sm-12">
                <div class="input-group">
                  <input  name="mail[<?=$key?>]" value="<?=$value?>" type="text" class="form-control">
                  <span class="input-group-addon">
          ...
          <fieldset class="d-adnotes">
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-8">
                <a  href="?accounts-user=accounts-new&reset=yes" class="btn btn-block btn-danger">
                  <i class="fa fa-fw fa-lg fa-repeat"></i>&nbsp;Wyczyść</a>
              </div>
            </div>
          </fieldset>
	  </form>

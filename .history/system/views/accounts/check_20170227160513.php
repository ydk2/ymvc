...
<div class="col-sm-5">
    ...
    <p><?=intl::_('miasto')?> <?=$address['city']?></p>
    <p><?=intl::_('ulica')?> <?=$address['street']?>
     <?=intl::_('numer')?> <?=$address['number']?>  <?=($address['apartament']!='')?intl::_('lokal').' '.$address['apartament']:''?></p>
    <p><?=intl::_('kod pocztowy')?> <?=$address['postal_code']?> <?=intl::_('poczta')?> <?=$address['postal_city']?></p>
    <p><?=intl::_('kraj')?>  <?=$address['country']?></p>
    </div>

    ...
    <form action="?accounts-users=accounts-list" role="form">
      <div class="form-group">
        <div class="input-group">
          ...
          <input name="query" value="<?=helper::get('query')?>" type="text" class="form-control" placeholder="Wpisz zapytanie">

          <span class="input-group-addon">Filter</span>
          <select name="filter" class="form-control">
            <option value="account_name">Nazwa</option>
            <option value="account_login">Login</option>
            <option value="account_email">E-mail</option>
            <option value="account_role">Typ konta</option>
          </select>

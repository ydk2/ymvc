<div class="row">
  <div class="col-sm-12">
    ...
    <form class="form-horizontal text-info .form" method="POST" action="?accounts-users=accounts-save&user="<?=helper::get('id')?>
        role="form">
            ...
            <div class="form-group">
              <div class="col-sm-12">
                ...
                <label class="checkbox-inline">
                  ...
                  <input name="can_login" value="<?=$this->userdetails['can_login']?>" id="d-login-check" type="checkbox" data-toggle="toggle" data-on="Tak"
                  data-off="Nie" data-onstyle="success" data-offstyle="danger"<?=($this->userdetails['can_login']=='y')?' checked="checked"':'';?>>
                  <i class="fa fa-lg fa-lock"></i>
                  <strong>&nbsp;Logowanie do konta</strong>
                </label>
                <label class="checkbox-inline">
                  <input name="active" value="<?=$this->userdetails['can_login']?>" type="checkbox" data-toggle="toggle" data-on="Konto Aktywne" data-off="Konto Nieaktywne"
                  data-onstyle="success" data-offstyle="danger"<?=($this->userdetails['active']=='y')?' checked="checked"':'';?>>

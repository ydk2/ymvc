...
<div class="col-sm-5">
    ...
    <b><?=intl::_('miasto')?></b><span> <?=$address['city']?></span>
    <b><?=intl::_('ulica')?></b><span> <?=$address['street']?>
     <?=intl::_('numer')?> <?=$address['number']?>  <?=($address['apartament']!='')?intl::_('lokal').' '.$address['apartament']:''?></span>
    <b><?=intl::_('kod pocztowy')?></b><span> <?=$address['postal_code']?> <?=intl::_('poczta')?> <?=$address['postal_city']?></span>
    <b><?=intl::_('kraj')?></b><span>  <?=$address['country']?></span>
    </div>

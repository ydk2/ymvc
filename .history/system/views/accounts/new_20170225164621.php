...
<div class="col-sm-12">
  ...
  <div class="col-sm-12">
    ...
    <form class="form-horizontal text-info d-form" method="POST" action="?accounts-users=accounts-save"
        role="form">
         <fieldset class="d-account">
            <div class="form-group">
              <div class="col-sm-12">
                ...
                <label class="checkbox-inline">
                  <input type="checkbox" data-toggle="toggle" data-on="Zakończ edycję" data-off="Edytuj"
                  data-onstyle="info" data-offstyle="primary" id="d-account-edit">
          ...
          <fieldset class="d-contact">
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <input name="account_born" value="<?=$this->userdetails['account_born']?>" type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-at fa-lg"></i>&nbsp;Data Urodzin</span>
                </div>
              </div>
            </div>
          ...
          <fieldset class="d-adnotes">
            <div class="form-group">
              <div class="col-sm-12">
                <h4>Adnotacje</h4>
                <textarea id="summernote" name="adnotation" rows="5" class="form-control" placeholder="Adnotacje"><?=(isset($this->userdetails['adnotation']))?$this->userdetails['adnotation']:'';?></textarea>
              </div>
            </div>
          </fieldset>

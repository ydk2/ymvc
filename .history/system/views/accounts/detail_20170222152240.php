        ...
        role="form">
         <fieldset class="d-account">
          ...
          <fieldset class="d-address-send d-can-delete">
              <h4>Dane Adresowe <?=$next?></h4>
            <div class="form-group">
              <div class="col-sm-12">
                <h5>Adres siedziby</h5>
                <div class="input-group">
                  <input name="address[<?=$next?>][city]" value="" type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Miasto</span>
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <input name="address[<?=$next?>][street]" value=""  type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Ulica</span>
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <input name="address[<?=$next?>][number]" value=""  type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Numer budynku</span>
                  <input name="address[<?=$next?>][apartament]" value=""  type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Numer lokalu</span>
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <input name="address[<?=$next?>][postal_code]" value="" type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Kod</span>
                  <input name="address[<?=$next?>][postal_city]" value="" type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Poczta</span>
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <input name="address[<?=$next?>][country]" value="" type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Kraj</span>
                </div>
              </div>

          ...
          <fieldset class="d-address d-can-delete">
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <h5>Adres siedziby</h5>
                <div class="input-group">
                  <input name="address[][city]" value="" type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Miasto</span>
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <input name="address[][street]" value=""  type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Ulica</span>
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <input name="address[][apartament]" value=""  type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Numer lokalu</span>
                  <input name="address[][number]" value=""  type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Numer budynku</span>
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <input name="address[][postal_code]" value="" type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Kod</span>
                  <input name="address[][postal_city]" value="" type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Poczta</span>
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <input name="address[][country]" value="" type="text" class="form-control">
                  <span class="input-group-addon">
                    <i class="fa fa-envelope fa-lg"></i>&nbsp;Kraj</span>
                </div>
              </div>

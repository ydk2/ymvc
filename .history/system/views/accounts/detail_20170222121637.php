         ...
         <fieldset class="d-account">
          ...
          <fieldset class="d-contact">
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <input  name="account_phone" value="<?=$this->userdetails['account_phone']?>" type="text" class="form-control">
                  <span class="input-group-addon">
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <input  name="account_fax" value="<?=$this->userdetails['account_fax']?>" type="text" class="form-control">
                  <span class="input-group-addon">
            ...
            <div class="form-group">
              <div class="col-sm-12">
                <div class="input-group">
                  <input  name="account_www" value="<?=$this->userdetails['account_www']?>" type="text" class="form-control">
                  <span class="input-group-addon">

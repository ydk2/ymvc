  ...
  <div class="row">
      ...
      ?>
      <a class="btn btn-warning pull-left" href="<?=HOST_URL.'?manage'.S.'manage'.'='.'manage'.S.'groups&group='.helper::session('backlink')?>"><?=intl::_('Wróć')?></a>
      <?php
        } else {
          helper::session_Set('backlink',$this->group);
        }
      ?>
      </div>
      <div class="col-sm-12">

...
if($pagination!=null){
  ...
  $pagination->link = $this->data->link.'&path='.helper::get('path');
  $pagination->groups = $this->group;
  $offset=(helper::get('p')=='')?1:intval(helper::get('p'));
  $list = $pagination->paginate_list($this->files,$offset,$pagination->limit);
}
?>
<div class="row">

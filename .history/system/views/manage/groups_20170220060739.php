  ...
  <div class="list-group">
    ...
    <a class="list-group-item" href="<?=$this->link?>=manage<?=S;?>layouts&group=<?=$grp?>">Rozkład</a>
    <a class="list-group-item" href="<?=$this->link?>=manage<?=S;?>menus&group=<?=$grp?>">Menu</a>
    <a class="list-group-item" href="<?=$this->link?>manage<?=S;?>modules<?=S;?>list&group=<?=$grp?>">Moduły</a>
  </div>
  <?php endif;?>

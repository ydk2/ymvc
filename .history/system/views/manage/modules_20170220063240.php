...
<div class="col-sm-12">
    ...
    <div class="form-group">
        ...
        <span class="input-group-btn">
    	  <button class="btn btn-success" name="check[one]" value="true" type="submit">one</button>
    	  <button class="btn btn-success" name="check[two]" value="true" type="submit">twue</button>
        </span>
        </div>
    </div>
    </form>

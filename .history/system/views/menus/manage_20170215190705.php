  ...
  <div class="col-sm-9">
       <form role="form" action="<?=$this->data->link?>&action=add" method="post">
       <select name="item[pos]" type="text" class="form-control">
         <option value="1" selected="selected">1</option>
       </select>
       <input name="item[title]" type="text" class="form-control" value="">
       <input name="item[link]" type="text" class="form-control" value="">
       <select name="item[parent]" class="form-control">

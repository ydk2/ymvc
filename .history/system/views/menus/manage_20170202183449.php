            ...
            <form role="form" action="<?=HOST_URL ?>?menus<?=S;?>mngmenus&action=add&group=<?=$this->group?>" method="post">
              <table class="table table-condensed">
                ...
                <tbody>
                  <tr>
                    <td>
                      <select name="item[99][pos]" type="text" class="form-control">
                        <option>1</option>
                      </select>
                    </td>
                    <td>
                      <input name="item[99][title]" type="text" class="form-control" value="">
                    </td>
                    <td>
                      <input name="item[99][link]" type="text" class="form-control" value="">
                    </td>
                    <td>
                      <select name="item[99][parent]" class="form-control" value="">
                        <option>Brak</option>
                      </select>
                    </td>
                    <td>
                      <input name="item[99][group]" type="hidden" value="<?=$this->group?>">
                      <input name="item[99][id]" type="hidden" value="99">

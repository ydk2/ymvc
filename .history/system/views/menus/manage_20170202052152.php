...
<?php else: ?>
        <div class="row">
          <div class="col-sm-12">
            <div class="well">
              <h2 class="text-primary"><?=$this->data->message->header?></h2>
              <p class="text-primary"><?=$this->data->message->text?></p>
              <a href="<?=$this->data->message->link?>" class="btn btn-info btn-large">OK</a>
            </div>
          </div>
        </div>
<?php endif ?>
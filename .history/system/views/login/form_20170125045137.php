            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="row login-form">
                  <div class="col-md-12">
                    <form class="form-horizontal" role="form" method="POST" id="login" action="?login-form&action=login">
                      <div class="form-group">
                        <div class="col-sm-2">
                          <label for="login" class="control-label">Login</label>
                        </div>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="login" placeholder="Login" name="account_login">
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-sm-2">
                ...
                <div class="row login-bar">
                  <div class="col-md-12">
                    <div class="alert alert-dismissable alert-info text-info">

...
{   
    ...
    //Inc('test/views/test/view','.html');  
        ...
        */
        ...
        $this->ViewData('data',json_encode($db->db->Query("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE = 'BASE TABLE' AND TABLE_SCHEMA='dbName';")->fetchAll(\PDO::FETCH_NAMED)));

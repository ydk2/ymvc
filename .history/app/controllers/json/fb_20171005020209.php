...
class FB extends \library\Core\Controller
{
    ...
    protected function check(){
        ...
        $fbuser = $user->asArray();
        if($fbuser == NULL){
          $data = array("error"=>400,"request"=>NULL);
          echo json_encode($data, JSON_FORCE_OBJECT);
        } else {
          $data = array("error"=>0,"request"=>$fbuser);
          echo json_encode($data, JSON_FORCE_OBJECT);
        }
        ...
        $data = array("error"=>401,"request"=>NULL);
        echo json_encode($data, JSON_FORCE_OBJECT);
          //exit;
        ...
        //echo 'Facebook SDK returned an error: ' . $e->getMessage();
          //exit;
          $data = array("error"=>402,"request"=>NULL);
          echo json_encode($data, JSON_FORCE_OBJECT);
        }

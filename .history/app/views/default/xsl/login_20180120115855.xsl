...
<xsl:stylesheet 
    ...
    <controller xmlns="https://ydk2.tk/ymvc" name="login" path="app/controllers/json/login"/>
    <xsl:param name="controller" as="xs:string">app/controllers/json/login</xsl:param>

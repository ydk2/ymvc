...
if(!$('#d-account-edit').checked) {
    $(".d-form :input").prop('readonly', true);
    $(".d-form :textarea").prop('readonly', true);
} else {
    $(".d-form :input").prop('readonly', false);
    $(".d-form :textarea").prop('readonly', false);
}

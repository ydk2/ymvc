    ...
    try {
        if($view!=NULL) {
            ...
            if (file_exists($filename) && is_file($filename)) {
                ...
                $data = new \SimpleXMLElement('<?xml version="1.0" encoding="UTF-8"?><data><content>Content text</content></data>', null, false);
                ...
                $controller = $xpath->query('//xsl:param[@name="controller"]')[0]->nodeValue;

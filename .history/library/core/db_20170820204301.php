 ...
 */
    public function Lock($name,$which='WRITE'){
        ...
        try {
            $add = $this -> db -> exec($this->sql['lock']);
            return TRUE;
        } catch(Exception $e){
            if(defined('DBDEBUG'))
            var_dump($e);
    ...
    public function UnLock($name){
        ...
        try {
            $add = $this -> db -> exec($this->sql['unlock']);
            return TRUE;
        } catch(Exception $e){
            if(defined('DBDEBUG'))
            var_dump($e);
    ...
    public function isLock($name){
        ...
        try {
            $query = $this -> db -> query($this->sql['islock']);
    ...
    public function SBegin($name='T1'){
        ...
        try {
            $add = $this -> db -> exec($this->sql['SBegin']);
            return TRUE;
        } catch(Exception $e){
            if(defined('DBDEBUG'))
            var_dump($e);
    ...
    public function SCommit($name='T1'){
        ...
        try {
            $add = $this -> db -> exec($this->sql['SCommit']);
            return TRUE;
        } catch(Exception $e){
            if(defined('DBDEBUG'))
            var_dump($e);
    ...
    public function SRelease($name='T1'){
        ...
        try {
            $add = $this -> db -> exec($this->sql['SRelease']);
            return TRUE;
        } catch(Exception $e){
            if(defined('DBDEBUG'))
            var_dump($e);
    ...
    public function SRollback($name='T1'){
        ...
        try {
            $add = $this -> db -> exec($this->sql['SRollback']);
            return TRUE;
        } catch(Exception $e){
            if(defined('DBDEBUG'))
            var_dump($e);
    ...
    public function Begin(){
        ...
        try {
            $add = $this -> db -> exec($this->sql['Begin']);
            return TRUE;
        } catch(Exception $e){
            if(defined('DBDEBUG'))
            var_dump($e);
    ...
    public function Prepare($this->sql[''],$values=array()) {
        try {
    ...
    public function Exec($this->sql['']){
        try {
            $chk = $this -> db -> exec($this->sql['']);
            return $chk;
        } catch(Exception $e){
            if(defined('DBDEBUG'))
            var_dump($e);
    ...
    public function Count($table,$this->sql['']='',$values=array()) {
        $count = $this -> db -> query('SELECT count(*) FROM '.$table.' '.$this->sql['']);
    ...
    public function Delete($table,$this->sql[''],$values=array()) {
        $del = $this -> db -> prepare('DELETE FROM '.$table.' WHERE '.$this->sql['']);
        $del -> execute($values);
        $check = $del->rowCount();
        if ($check > 0) {
            return $check;

...
INSERT INTO users (name, email, password, role, role_id) VALUES('admin', 'admin@localhost.to', '40bd001563085fc351653210ea1ff5c5ecbdbbeef', 'admin',0);
INSERT INTO users (name, email, password, role, role_id) VALUES('me', 'me@be.mu', '40bd001563085fc351653210ea1ff5c5ecbdbbeef', 'editor',7);
INSERT INTO users (name, email, password, role, role_id) VALUES('kupa', 'kupa@kibel.tu', '36a32e106cbfd11fd108e8c108e38d10ad10b41f57f1a', 'user',10);

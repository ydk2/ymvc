  ...
  * ================================ */
  ...
  , template: function() {
      if (this.options.bsVersion == '2') {
        ...
        return '<div class="combobox-container"> <input type="hidden" /> <div class="input-group"> <input type="text" autocomplete="false" /> <span class="input-group-addon dropdown-toggle" data-dropdown="dropdown"> <span class="caret" /> <span class="glyphicon" /> </span> </div> </div>'
      }
    }

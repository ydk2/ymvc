...
$(document).ready(function (e) {
   ...
   $('#d-address-send').change(function () {
    ...
    if ($('#d-account-edit').prop('checked') || !$('#d-account-edit').lenght) {
        $(".d-form :input").prop('disabled', false);
        $('#summernote').summernote('enable');
        $('.d-delete').on('click', function () {
            $(this).closest('.d-can-del').remove();
    ...
    $('#d-account-edit').prop('disabled', false);
...
function add() {
    $('#d-add-new .btn').click(function () {
        if ($('#d-add-new select').val() != "Wybierz" && $('#d-add-new select').val() != "") {
            var idata = $('#d-add-new select [value="' + $('#d-add-new select').val() + '"]');
            var ndata = (idata.data('type') !== null) ? idata.data('type') : encodeURIComponent($('#d-add-new select').val());
            var vdata = (idata.val() !== undefined) ? idata.val() : $('#d-add-new select').val();

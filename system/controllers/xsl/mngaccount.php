...
class MngAccount extends PHPRender {
	...
	public function Init() {
		...
		$this->RegisterView(SYS.V.'admin'.S.'account');
		$this->RegisterView(SYS.V.'admin'.S.'login');
		$this->RegisterView(SYS.V.'admin'.S.'register');
		$this->RegisterView(SYS.V.'admin'.S.'message');
		$this->RegisterView(SYS.V.'admin'.S.'success');
		$this->RegisterView(SYS.V.'admin'.S.'check');
		$this->SetModel(SYS.M.'accountsdata');

		if(Helper::Get('admin'.S.'mngaccount') == '')
		$this->SetView(SYS.V . "admin".S."login");
	...
	public function Run() {
		...
		/*
			...
			*/
			...
			$this->SetView(SYS.V . "admin".S."account");
			...
			switch (Helper::get('action')) {
				...
				case 'register' :
					...
					$this -> alert_mode = "alert-info";
					$this->SetView(SYS.V . "admin".S."register");

...
class Pagination extends Render {
	...
	public function Run(){
		//$this->paginate_lenght($this->items);
	}

    public function paginate_offset($offset){
		return ($offset-1)*$this->limit;
    }
    public function paginate_offset_sum(){
    ...
    public function paginate_lenght($array=array()){
		$lenght = count($array);
		$this->lenght = ceil($lenght/$this->limit);
    }
    public function paginate_lenght_sum($lenght){
		$this->lenght = ceil($lenght/$this->limit);
    }

...
border-right: 5px solid #ffa500;
				...
				<main class="main">
					<div class="section">
						<div class="container">
							<div class="col-md-12">
								<div class="jumbotron">
									<h1 id="heads" class="text-warning">
										<span class="fa fa-3x fa-fw fa-exclamation-triangle"></span>
										<xsl:text> </xsl:text>
									...
									<xsl:if test="$inside != 'yes' or $show_link = 'yes'">
										<xsl:for-each select="data/links/a">
											<a class="btn btn-large btn-warning" href="{@href}">
	...
	<xsl:template name="inside">
		<div class="row">
			<div class="col-md-12">
				<div class="alert alert-dismissable alert-warning lead">

      ...
      <div class="col-sm-12">
        <div class="input-group">
            ...
            <?php $i++; endforeach;?>
          	...
          	<span class="input-group-addon"><?=intl::_('pos')?></span>
            <input class="form-control" type="text" name="items[<?=$id?>][title]" value="<?=$entry['title']?>">

          	<span class="input-group-addon"><?=intl::_('name')?></span>
            ...
            <option value=""><?=intl::_('No parent')?></option>
            ...
            <?php endforeach;?>
          	...
          	<span class="input-group-addon"><?=intl::_('parent')?></span>

            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="row login-form well">
                  <div class="col-md-12">
                    <h1 class="text-primary">Witaj, <?=$this->ViewData('user_name');?></h1>
                    <p class="lead text-primary">Zostałeś zalogowany w systemie</p>
                    <p>Teraz możesz przejść do konta</p>
                  </div>
                  <div class="col-sm-12">
                    <a class="btn btn-block btn-info" href="<?=$this->ViewData('success_link');?>">Przejdź do konta</a>
                    <a class="btn btn-block btn-danger" href="?login<?=S;?>form&action=logout">Wyloguj</a>
                  </div>
                </div>
